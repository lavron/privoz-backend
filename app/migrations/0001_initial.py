# Generated by Django 5.0.1 on 2024-03-07 05:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_card_protection', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='hero', to='app.event')),
                ('premium_sector', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='hero', to='app.basesector')),
            ],
        ),
        migrations.CreateModel(
            name='Player',
