...
class Player(models.Model):
    ...
    event_cards = models.ManyToManyField('EventCard', related_name='players', default=None)
    product_cards = models.ManyToManyField('ProductCard', related_name='players', default=None)
